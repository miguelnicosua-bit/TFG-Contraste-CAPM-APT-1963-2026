...
Genera cinco figuras en alta resolución (300 dpi) listas para insertar
en el TFG:
  1. SML empírica vs teórica
...
# ========================================================================
# GRÁFICO 1: SML EMPÍRICA VS TEÓRICA
# ========================================================================
...
ax.plot(x_teo, y_emp, "-", color="red", linewidth=2,
        label=f"LMA empírica (pendiente = {coef[0]:.2f}%)", zorder=2)
...
ax.set_title(""
             "100 carteras Tamaño $\\times$ BE/ME, julio 1963 – abril 2026")
...
ax.set_ylabel("Decil Tamaño (1 = pequeña   ←→   10 = grande)")
ax.set_title(
             "Verde: $\\hat{\\alpha}>0$ (CAPM infravalora)   "
             "Rojo: $\\hat{\\alpha}<0$ (CAPM sobrevalora)")
...
ax.set_title("Exceso de rendimiento medio anualizado (%) por cartera\n"
             "Patrón: crece de izquierda a derecha (value premium)")
